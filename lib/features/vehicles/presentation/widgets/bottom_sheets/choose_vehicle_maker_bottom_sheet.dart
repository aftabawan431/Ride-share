...
class ChooseVehicleMakerBottomSheet {
  ...
  Future show() async {
    ValueNotifier<List<VehicleMakes>> vehicleTypesNotifier =
        ValueNotifier(vehicleProvider.getVehicleInitialsResponse!.vehicleMakes);
    vehicleTypesNotifier.value
        .sort((a, b) => a.make.toLowerCase().compareTo(b.make.toLowerCase()));
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      CustomTextFormField(
                        ...
                        onChanged: (value) {
                          vehicleTypesNotifier.value = vehicleProvider
                              .getVehicleInitialsResponse!.vehicleMakes
                              .where((element) => element.make
                                  .toLowerCase()
                                  .contains(value.toLowerCase()))
                              .toList();

                          vehicleTypesNotifier.value.sort((a, b) => a.make
                              .toLowerCase()
                              .compareTo(b.make.toLowerCase()));
                        },
                      ),
                      SizedBox(
                        height: 5.h,
                      ...
                      Expanded(
                        child: ValueListenableBuilder<List<VehicleMakes>>(
                                ...
                                itemBuilder: (context, index) {
                                  return InkWell(
                                      onTap: () {
                                        ...
                                        vehicleProvider
                                                .vehicleMakerController.text =
                                            vehicleTypes[index]
                                                .make
                                                .toTitleCase();
                                        vehicleProvider.selectedMaker =
                                            vehicleTypes[index].make;
                                        vehicleProvider.setSelectedModel(null);
                                        vehicleProvider.vehicleModelController.clear();
                                        vehicleProvider.getModelsResponseModel=null;
